...
class InfiniteGridMenu {
  ...
  camera = {
    ...
    fov: Math.PI / 4,
    aspect: 1,
    position: vec3.fromValues(0, 0, 3) as vec3, // Added assertion
  ...
  #init(onInit: ((sk: InfiniteGridMenu) => void) | null) {
    ...
    if(!this.discProgram) throw new Error("Could not create disc program");
  ...
  #updateProjectionMatrix(gl: WebGL2RenderingContext) {
    ...
    const distance = (this.camera.position[2] as number); // asserted
