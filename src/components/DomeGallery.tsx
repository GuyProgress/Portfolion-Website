...
export default function DomeGallery({
  ...
  return (
    ...
    >
      <main ref={mainRef} className="sphere-main w-full h-full rounded-[inherit] overflow-hidden">
        <div className="stage cursor-grab active:cursor-grabbing w-full h-full">
